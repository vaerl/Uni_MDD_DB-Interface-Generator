...
public class ProjectMddAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link projectMdd.Entity
	 * <em>Entity</em>}'. <!-- begin-user-doc --> This default implementation
	...
	/**
	 * Creates a new adapter for an object of class '{@link projectMdd.Association
	...
	/**
	 * Creates a new adapter for an object of class '{@link projectMdd.Backend
	 * <em>Backend</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
