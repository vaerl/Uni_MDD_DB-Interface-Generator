...
public class ProjectMddPackageImpl extends EPackageImpl implements ProjectMddPackage {
	 ...
	 * @generated
	 */
	public EReference getEntity_Association() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_Entities() {
	 ...
	 * @generated
	 */
	public EReference getBackend_Associations() {
	...
	public void createPackageContents() {
		...
		createEReference(backendEClass, BACKEND__ASSOCIATIONS);

		entityEClass = createEClass(ENTITY);
		createEReference(entityEClass, ENTITY__ASSOCIATION);

		associationEClass = createEClass(ASSOCIATION);
		createEReference(associationEClass, ASSOCIATION__ENTITIES);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getBackend_Associations(), this.getAssociation(), null, "associations", null, 0, -1,
				Backend.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(entityEClass, Entity.class, "Entity", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEntity_Association(), this.getAssociation(), this.getAssociation_Entities(), "association",
		...
		initEReference(getAssociation_Entities(), this.getEntity(), this.getEntity_Association(), "entities", null, 1,
