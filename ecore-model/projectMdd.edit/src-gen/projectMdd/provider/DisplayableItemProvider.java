...
/**
 * This is the item provider adapter for a {@link projectMdd.Displayable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DisplayableItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public DisplayableItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Displayable"));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Displayable_type") + " " + displayable.isDisplay();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Displayable.class)) {
