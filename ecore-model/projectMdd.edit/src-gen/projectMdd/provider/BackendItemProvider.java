...
/**
 * This is the item provider adapter for a {@link projectMdd.Backend} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BackendItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProjectMddPackage.Literals.BACKEND__ENTITIES);
			childrenFeatures.add(ProjectMddPackage.Literals.BACKEND__RELATION);
			childrenFeatures.add(ProjectMddPackage.Literals.BACKEND__DATABASE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ProjectMddPackage.Literals.BACKEND__ENTITIES,
				ProjectMddFactory.eINSTANCE.createEntity()));

		newChildDescriptors.add(createChildParameter(ProjectMddPackage.Literals.BACKEND__RELATION,
				ProjectMddFactory.eINSTANCE.createRelation()));

		newChildDescriptors.add(createChildParameter(ProjectMddPackage.Literals.BACKEND__DATABASE,
				ProjectMddFactory.eINSTANCE.createDatabase()));
	}
