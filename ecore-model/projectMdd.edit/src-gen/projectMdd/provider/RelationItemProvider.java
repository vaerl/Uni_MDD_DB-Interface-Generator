...
/**
 * This is the item provider adapter for a {@link projectMdd.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationItemProvider extends PersistableItemProvider {
	/**
	...
	protected void addStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Relation_start_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Relation_start_feature",
								"_UI_Relation_type"),
						ProjectMddPackage.Literals.RELATION__START, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Relation_name_feature",
								"_UI_Relation_type"),
						ProjectMddPackage.Literals.RELATION__NAME, true, false, false,
	...
	protected void addEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Relation_end_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Relation_end_feature",
								"_UI_Relation_type"),
						ProjectMddPackage.Literals.RELATION__END, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Relation_type_feature",
								"_UI_Relation_type"),
						ProjectMddPackage.Literals.RELATION__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
